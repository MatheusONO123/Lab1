        ...
        <form action="espaco" method="post">
            ...
            <div class="form-linha">
                ...
                <div class="form-grupo">
                    ...
                    <input type="number" name="capacidade" placeholder="Número de pessoas" min="1"
                           value="<%= espacoEditar != null ? espacoEditar.getCapacidade() : "" %>" required>
                </div>
            </div>
            <div class="form-linha">
                <div class="form-grupo">
                ...
                %>
                    <tr>
                        ...
                        <td style="display:flex;gap:6px;flex-wrap:wrap;">
                            ...
                            <a href="espaco?acao=excluir&id=<%= e.getId() %>"
