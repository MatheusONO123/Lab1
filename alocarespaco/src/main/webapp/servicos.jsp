...
<div class="conteudo">
            ...
            <div class="form-linha">
                ...
                <div class="form-grupo">
                    ...
                    <input type="text" name="valor" placeholder="0,00"
                           value="<%= servicoEditar != null ? servicoEditar.getValor() : "" %>" required>
                </div>
            </div>
            <div class="form-grupo">
                <label>Descrição</label>
                <textarea name="descricao" rows="3" placeholder="Descrição do serviço..."><%= servicoEditar != null ? servicoEditar.getDescricao() : "" %></textarea>
            </div>
            <div style="display:flex; gap:10px; margin-top:6px;">
                <button type="submit" class="btn btn-primario">&#128190; Salvar</button>
                <% if (servicoEditar != null) { %><a href="servicos.jsp" class="btn btn-outline">Cancelar</a><% } %>
            </div>
        </form>
    </div>
    ...
    <div class="tabela-container">
        ...
        <table>
            <thead>
                <tr><th>#</th><th>Nome</th><th>Descrição</th><th>Valor</th><th>Ações</th></tr>
            </thead>
            <tbody>
                <% if (servicos.isEmpty()) { %>
                ...
                <% } else { for (Servico s : servicos) { %>
                    <tr>
                        ...
                        <td style="display:flex;gap:6px;flex-wrap:wrap;">
                            ...
                            <a href="servico?acao=excluir&id=<%= s.getId() %>"
